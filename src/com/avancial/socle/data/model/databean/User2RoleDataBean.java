...
public class User2RoleDataBean {
	...
	protected User2RoleDataBean userCreateUser;
	@OneToOne
	@JoinColumn(name = "idUserUpdateUser")
	protected User2RoleDataBean userUpdateUser;
	...
	public User2RoleDataBean getUserCreateUser() {
		return this.userCreateUser;
	}

	public void setUserCreateUser(User2RoleDataBean userCreateUser) {
		this.userCreateUser = userCreateUser;
	}

	public User2RoleDataBean getUserUpdateUser() {
		return this.userUpdateUser;
	}

	public void setUserUpdateUser(User2RoleDataBean userUpdateUser) {
